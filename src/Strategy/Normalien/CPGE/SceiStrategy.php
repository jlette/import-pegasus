...
class SceiStrategy extends AbstractStrategy
{
    ...
    /**
     * Le code concours des filières scientifiques est résolu depuis l'annuaire :
     * ce cursus peut donc produire un canevas en mode dégradé, sur la table de
     * secours embarquée. Le gestionnaire doit en être averti.
     *
